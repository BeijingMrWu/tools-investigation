...
public class StarterForETLApplication {

  private static Logger log = LoggerFactory.getLogger(StarterForETLApplication.class);

  public static void main(final String... args) {
    SpringApplication.run(StarterForETLApplication.class, args);
  }
